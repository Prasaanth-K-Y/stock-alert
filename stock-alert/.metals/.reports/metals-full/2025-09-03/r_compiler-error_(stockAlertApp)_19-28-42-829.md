...
file:///C:/Users/Pky/Desktop/scala/scala-files/stock-alert/target/scala-2.13/routes/main/controllers/ReverseRoutes.scala
### java.lang.AssertionError: assertion failed: (List(Stamp(2023-06-21T09:18:19Z,1204558,java.lang.Object@4bac35e0)),0)
...
action parameters:
uri: file:///C:/Users/Pky/Desktop/scala/scala-files/stock-alert/target/scala-2.13/routes/main/controllers/ReverseRoutes.scala
text:
```scala
...
package controllers {
  ...
  class ReverseStockController(_prefix: => String) {
    ...
    // @LINE:2
    def getItem(id:Long): Call = {
      
      Call("GET", _prefix + { _defaultPrefix } + "items/" + play.core.routing.dynamicString(implicitly[play.api.mvc.PathBindable[Long]].unbind("id", id)))
    }
